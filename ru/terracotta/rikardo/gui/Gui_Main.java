package ru.terracotta.rikardo.gui;
...
import ru.terracotta.rikardo.utils.snow.SnowManager;
...
public class Gui_Main extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        fr.drawCenteredStringWithOutline(Main.NAME + " " + Main.SUFFIX, x + 155, y - 7, Color.magenta.getRGB());
        ...
        if(currentmod == null){
            ...
            int pos1 = x + 3;
            int pos2 = x1 - 153;
            for(Module module : Main.moduleManager.getModulesInCategory(currentcat)){
            ...
            boolean left = true;
            for(Setting setting : Main.settingManager.getSettings(currentmod)){
