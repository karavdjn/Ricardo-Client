package ru.terracotta.rikardo.utils.font;
...
public final class CustomFontRenderer extends CFont {
    ...
    public float drawStringWithShadow(String text, float x, float y, int color) {
        float shadowWidth = this.drawString(text, (double)x + 1D, (double)y + 1D, color, true);
    ...
    public void drawTotalCenteredString(String text, double x, double y, int color) {
        drawString(text, x - getStringWidth(text) / 2, y - this.getHeight() / 2, color);
    }

    public void drawTotalCenteredStringWithShadow(String text, double x, double y, int color) {
        drawStringWithShadow(text, x - this.getStringWidth(text) / 2, y - this.getHeight() / 2F, color);
    }
